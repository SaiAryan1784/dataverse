...
const Nav = () => {
    return (
        <div>
            <nav className='flex items-center justify-between pl-25 py-3 backdrop-blur-[2px] fixed top-0 left-0 right-0' >
                <div>
                    <Link to="/"><img src={logo} className='h-[80px] w-[80px]' alt="Logo" /></Link>
                </div>
                <div className='text-white mr-[20px] text-1xl font-Orbitron'>
                    <ul className="flex gap-[2.0rem]">
                        <li>
